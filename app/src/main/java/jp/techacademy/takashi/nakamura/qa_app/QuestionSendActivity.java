...
public class QuestionSendActivity extends AppCompatActivity
    ...
    protected void onActivityResult(int requesetCode, int resultCode, Intent data) {
        if (requesetCode == CHOOSER_REQUEST_CODE) {

            if (requesetCode != RESULT_OK) {
                if (mPictureUri != null) {
    ...
    private void showChooser() {
        ...
        Intent chooserIntent = Intent.createChooser(galleryIntent, "画像をす得");

        // EXTRE_INITIAL_INTENTSにカメラ撮影のIntentを追加
